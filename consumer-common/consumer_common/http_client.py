...
async def notify_job_completed(analysis_service_url: str, job_id: str, output: str) -> None:
    await _update_job_result(analysis_service_url, job_id, status="COMPLETED", output=output)

async def notify_job_failed(analysis_service_url: str, job_id: str, output: str) -> None:
    await _update_job_result(analysis_service_url, job_id, status="FAILED", output=output)
